...
// Notifications are scoped to the signed-in user: either addressed to their
// exact user id, or broadcast to everyone with their role. Every entry
// carries the real authenticated user (actor) that triggered it.
